...
class RandomAgentGridSoccer(gym.Env):
    def __init__(self, render_mode=None, size=10):
        ...
        self.goal_loc2 = np.array([0, size // 2])
    ...
    def _get_obs(self):
        if self.has_ball == 0:
            return np.concatenate((self._agent_location, self._random_agent_location, self._target_location))
        else:
            return np.concatenate((self._agent_location, self._random_agent_location, self.goal_loc, self.goal_loc2))
    ...
    def reset(self, seed=None, options=None):
        ...
        self._random_agent_location = np.array([self.size - 1, self.size // 2])
