...
class env(gym.Env):
    def __init__(self):
        ...
        self.action_space = Tuple(( # TODO Simplify action space
            Discrete(4),
            Discrete(3),
            Discrete(2),
            Discrete(3)
...
# env = env()
# obs, _ = env.reset()
# player_actions = [torch.tensor([[0, 0, 0, 0], [0, 0, 0, 0]]), torch.tensor([[0, 0, 0, 0], [0, 0, 0, 0]])]
# times = []
...
# TODO: change get ball length from
# TODO: test training loop on cart pole
# TODO: save models and play new models against older ones
# TODO: Create a whole new model
