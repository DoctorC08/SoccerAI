...
def ConfigsToWandb(env_config: EnvConfig, agent_config: AgentConfig, buffer_config: BufferConfig, training_params: TrainingParams, trainer_params: TrainerConfig):
    wandb_config = {}
